...
**
** Created: Wed 21. Dec 14:23:49 2011
...
static const char qt_meta_stringdata_Scanner[] = {
    "Scanner\0\0fileCountChanged(int)\0"
    "name,fullname\0newFile(QString,QString)\0"
    "stop()\0"
};
...
int Scanner::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: fileCountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: newFile((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 2: stop(); break;
        default: ;
        }
        _id -= 3;
...
// SIGNAL 0
void Scanner::fileCountChanged(int _t1)
{
...
// SIGNAL 1
void Scanner::newFile(QString _t1, QString _t2)
{
